$(function(){
 ...
 /* Below is code for acitvity Module x-editable*/

    $('.act_edit').editable({
    });

	$('.act_duration').editable({
        source: [
	    ...
	    $('.act_list').editable({
        source: "/activity/getactlist/name/Types of Activity"
    });

	    $('.act_people').editable({
        source: "/activity/getosoby",
        select2: {
            width: 200,
 ...
 /* Above is code for acitvity Module x-editable*/
