...
$.fn.dataTableExt.oPagination.listbox = {
    ...
    "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
        var nInput = $('<select class="form-control" data-toggle="tooltip" data-title="Wybierz stronę">').wrap('<li>');
        ...
        var nFirst = $('<a class="paginate_button first" data-toggle="tooltip" data-title="Pierwsza strona"><i class="icon-to-start"></i></a>').wrap('<li>');
        var nPrevious = $('<a class="paginate_button previous" data-toggle="tooltip" data-title="Poprzednia strona"><i class=icon-left-open-1></i></a>').wrap('<li>');
        var nNext = $('<a class="paginate_button next" data-toggle="tooltip" data-title="Następna strona"><i class="icon-right-open-1"></i></a>').wrap('<li>');
        var nLast = $('<a class="paginate_button last" data-toggle="tooltip" data-title="Ostatnia strona"><i class="icon-to-end"></i></a>').wrap('<li>');
