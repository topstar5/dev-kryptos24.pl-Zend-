...
tableMaxInit = function () {
    ...
    var initDatatableEvent = function (e, settings) {
        ...
        var changeLimitButton = $('<div class="dt-change-limit-section"><div class="input-group"><select class="form-control"></select><span class="input-group-btn show-notify processed" data-notify-text="#notify_trigger_mode_4_day"><button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="left" data-title="Ilość wyników na stronie"><i class="fa fa-th-list"></i></button></span></div></div>');
        changeLimitButton
...
widget.push({
    ...
    initElement: function (tg) {
        ...
        var myloc = new google.maps.LatLng(defaultLocation.lat, defaultLocation.long);
        ...
        google.maps.event.addListener(marker, 'dragend', function (event) {
            ...
            $('.longlatval').val(event.latLng.lng().toFixed(4)+'|'+event.latLng.lat().toFixed(4));
         });
        ...
        autocomplete.addListener('place_changed', function() {
          ...
          marker.setVisible(true);
            $('.longlatval').val(place.geometry.location.lng().toFixed(4)+'|'+place.geometry.location.lat().toFixed(4));
         });
