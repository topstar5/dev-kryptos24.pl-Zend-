...
class Application_Service_RegistryEvents
{
     ...
     * @param Zend_EventManager_Event $event
     */
    public static function onRegistryAssigneeGroupAdd(Zend_EventManager_Event $event)
    {
        // disable
        return;
     ...
     * @param Zend_EventManager_Event $event
     */
    public static function onRegistryAssigneeGroupRemove(Zend_EventManager_Event $event)
    {
        // disable
        return;
