...
class Application_Service_Events extends Zend_EventManager_EventManager
{
    ...
    static public function initEventManager()
    {
        ...
        $manager->attach('registry.assignee_group.add', 'Application_Service_RegistryEvents::onRegistryAssigneeGroupAdd');
        $manager->attach('registry.assignee_group.remove', 'Application_Service_RegistryEvents::onRegistryAssigneeGroupRemove');
